...
The manuscript is well aligned with the journal's focus on household economics, family formation, and the economic conditions shaping family outcomes. Its contribution is to integrate household financial preparedness and reproductive education within a single longitudinal family-economics framework while maintaining cautious association-based interpretation.

The analysis uses de-identified public-use NLSY79 data. No restricted identifiers or confidential respondent-level data were used. The author received no financial support for this work and declares no competing interests.

This manuscript is not under review elsewhere and has not been previously published. The blinded manuscript, separate title page, bibliography, analytic code, and audit tables are maintained in the project repository subject to public-use data redistribution rules.
