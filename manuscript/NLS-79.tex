...
\begin{table}[!htbp]
\centering
\caption{Robustness and Diagnostic Summary}
...
\begin{minipage}{0.95\textwidth}
\footnotesize
\textit{Notes:} Robustness checks are interpreted as sensitivity evidence, not as proof of causal identification.
\end{minipage}
\end{table}
